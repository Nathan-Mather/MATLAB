...
erase_compiled_function('hw3_q4_dynare_static');
erase_compiled_function('hw3_q4_dynare_dynamic');
M_.orig_eq_nbr = 8;
M_.eq_nbr = 8;
M_.ramsey_eq_nbr = 0;
...
var_list_ = char();
info = stoch_simul(var_list_);
save('hw3_q4_dynare_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('hw3_q4_dynare_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('hw3_q4_dynare_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('hw3_q4_dynare_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('hw3_q4_dynare_results.mat', 'estimation_info', '-append');
end
if exist('dataset_info', 'var') == 1
  save('hw3_q4_dynare_results.mat', 'dataset_info', '-append');
end
if exist('oo_recursive_', 'var') == 1
  save('hw3_q4_dynare_results.mat', 'oo_recursive_', '-append');
end
